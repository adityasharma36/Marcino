      ...
      <div className="flex items-center gap-4 sm:gap-6">
        {
          response != null ? 
           <button
             ...
             className="rounded-lg border border-pink-400/70 px-4 py-1.5 text-sm font-semibold tracking-wide text-slate-100 transition hover:-translate-x-2 hover:-translate-y-0.5 hover:bg-linear-to-r from-red-200 to-purple-300 hover:bg-pink-400 hover:text-slate-900 sm:px-5 sm:py-2 sm:text-base"
           >
          LOGOUT
        </button>

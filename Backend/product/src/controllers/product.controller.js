...
async function createProduct(req, res) {
    try {
        const { title, description, priceAmount, priceCurrency = 'INR', category ,stock} = req.body;
        ...
        const product = await productModel.create({ title, description, price, seller, images , category,stock });
